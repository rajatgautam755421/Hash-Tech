    ...
    <>
      ...
      <div className="container">
        <div className="HWD__main__row row mt-5 mb-5">
          <motion.div
            className="HWD__main__img1 col-md-7 col-sm-10"
      ...
      <div className="HWD__row2 container strictagileprocess">
        <div className="row">
          ...
          <div className="col-md-11 col-10">
            <div className="row">
              <h4 className="strictagileprocess-title">Strict Agile Process</h4>

              <div className="row">
                <h5>
                  <p className="strictagileprocess-para">
                    Driven by its team’s competence in collaboration and
                    cooperation, W3villa excels in and deploys cross-functional
                    expertise in its operational framework, follows practical
                    approach for overall product development and amalgamates
                    rational work ethics to serve the clients with utmost
                    sincerity. W3villa maneuvers agile methodologies to provide
                    avant-garde solutions including Blockchain and web
              ...
              <div className="row">
                <h5>
                  <p className="pragmaticapproachpresectiveperformance-para">
                    ...
                    approach for overall product development and amalgamates
                    rational work ethics to serve the clients with utmost
                    sincerity. Hash Technologies maneuvers agile methodologies
                    to provide avant-garde solutions including Blockchain and
